...
// Use same Supabase config as mobile app
const SUPABASE_URL = 'https://xjwdkgvsxijvxpoqulmb.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inhqd2RrZ3ZzeGlqdnhwb3F1bG1iIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzI1OTg4NzcsImV4cCI6MjA0ODE3NDg3N30.K-Wd-SzWlpFfjQdwGsJNLi5O7A5z0GpNfVxLOIHN-Oo';
