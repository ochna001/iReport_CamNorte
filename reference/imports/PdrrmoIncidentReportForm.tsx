import svgPaths from "./svg-96kt6505i7";
  ...
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-px pt-0 px-0 relative shrink-0 w-full" data-name="Heading 1">
      <div className="flex flex-col font-['Inter:Bold',_sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[17.4px] text-black w-full">
        <p className="leading-[normal]">PDRRMO Incident Report Form</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-px pt-0 px-0 relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[15.4px] text-black text-nowrap">
        <p className="leading-[normal] whitespace-pre">Vehicular Accident</p>
      </div>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-px pt-0 px-0 relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Inter:Bold',_sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[15.5px] text-black w-full">
        <p className="leading-[normal]">Patient Information</p>
      </div>
    </div>
  );
}
...
function Background2() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[12px] h-[546px] items-start left-[16px] pb-[30px] pt-[32px] px-[16px] right-[16px] rounded-[8px] top-[753.88px]" data-name="Background">
      <Heading4 />
      <Container15 />
      <Options />
      <Container17 />
      ...
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[14.9px] text-black w-[min-content]">
        <p className="leading-[normal]">Chief Complaint</p>
      </div>
      <Options1 />
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[14.9px] text-black w-[min-content]">
        <p className="leading-[normal]">Signs and Symtoms</p>
      </div>
      <Options1 />
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[14.9px] text-black w-[min-content]">
        <p className="leading-[normal]">Nature of Illness</p>
      </div>
      <Options1 />
    </div>
  );
...
function Button() {
  return (
    <div className="absolute bg-blue-600 box-border content-stretch flex h-[48px] items-center justify-center left-[27px] pb-[16px] pt-[15px] px-[6px] rounded-[6px] top-[1375.88px] w-[309px]" data-name="Button">
...
function Container29() {
  return (
    <div className="h-[1437px] overflow-auto relative shrink-0 w-full" data-name="Container">
      <Background1 />
      <Background2 />
      <Background4 />
      <Button />
...
export default function PdrrmoIncidentReportForm() {
  return (
    <div className="bg-gray-100 content-stretch flex flex-col items-start relative size-full" data-name="PDRRMO Incident Report Form">
