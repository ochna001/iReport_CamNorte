...
const translations: Record<Language, Record<string, string>> = {
  tl: {
    ...
    'camera.takePhoto': '📷 Kumuha ng Litrato',
    'camera.takeVideo': '🎥 Kumuha ng Video',
    'camera.chooseFromGallery': '🖼️ Pumili mula sa Gallery',
    'camera.takeAnotherPhoto': '📷 Kumuha ng Isa Pang Litrato',
    'camera.continueToForm': '📝 Magpatuloy sa Report Form',
    ...
    'camera.yourLocation': '📍 Iyong Lokasyon',
    ...
    'confirm.summary': '✅ Buod ng Report',
    ...
    'confirm.edit': '✏️ I-edit ang Report',
    'confirm.submit': '📤 Isumite ang Report',
    'confirm.submitting': 'Isinusumite...',
    'confirm.agreement': 'Sa pagsusumite ng report na ito, kinukumpirma ko na ang impormasyong ibinigay ay tama ayon sa aking kaalaman at nauunawaan ko na ang pagsusumite ng maling report ay maaaring magresulta sa legal na kahihinatnan sa ilalim ng Presidential Decree No. 1727, ng Cybercrime Prevention Act of 2012 (RA 10175), at ng Data Privacy Act (RA 10173).',
  ...
  en: {
    ...
    'camera.takeVideo': '🎥 Take Video',
    'camera.chooseFromGallery': '🖼️ Choose from Gallery',
    'camera.takeAnotherPhoto': '📷 Take Another Photo',
    'camera.continueToForm': '📝 Continue to Report Form',
    ...
    'camera.yourLocation': '📍 Your Location',
    ...
    'confirm.summary': '✅ Report Summary',
    ...
    'confirm.edit': '✏️ Edit Report',
    'confirm.submit': '📤 Submit Report',
    'confirm.submitting': 'Submitting...',
    'confirm.agreement': 'By submitting this report, I confirm that the information provided is accurate to the best of my knowledge and understand that filing a false report may result in legal consequences under Presidential Decree No. 1727, the Cybercrime Prevention Act of 2012 (RA 10175), and the Data Privacy Act (RA 10173).',
